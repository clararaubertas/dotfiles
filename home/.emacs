...
(set-face-attribute 'org-habit-alert-future-face nil :background		    "#002b36" :strike-through t :foreground "#cb4b16"  :weight 'bold )
(set-face-attribute 'org-habit-clear-face nil :background "#002b36"		    :strike-through nil :weight 'bold)
...
(set-face-attribute 'org-habit-overdue-face nil :background "#002b36"
		    :weight :bold :strike-through t :foreground "#d33682")
