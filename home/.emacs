...
(set-face-attribute 'org-habit-alert-face nil :background "#b58900" :bold t :strike-through nil)
...
(set-face-attribute 'org-habit-overdue-future-face nil :background "#657b83" :strike-through t)
